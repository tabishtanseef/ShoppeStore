...
{ 	
 ...
 $insert_user = "INSERT INTO checkout (first_name,last_name,address,email,postcode,city,mob_no) VALUES('$first_name','$last_name','$address','$email','$postcode','$city','$mob_no')";
